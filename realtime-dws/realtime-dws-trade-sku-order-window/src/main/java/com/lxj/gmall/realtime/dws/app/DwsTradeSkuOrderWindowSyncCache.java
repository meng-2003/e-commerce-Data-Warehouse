package com.lxj.gmall.realtime.dws.app;

/**
 * @author Laoxingjie
 * @description TODO
 * @create 2026/4/11 20:23
 **/
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.lxj.gmall.realtime.common.base.BaseApp;
import com.lxj.gmall.realtime.common.bean.TradeSkuOrderBean;
import com.lxj.gmall.realtime.common.constant.Constant;
import com.lxj.gmall.realtime.common.util.DateFormatUtil;
import com.lxj.gmall.realtime.dws.function.MapDimFunction;
...
public class DwsTradeSkuOrderWindowSyncCache extends BaseApp {
    ...
    private void joinDim(SingleOutputStreamOperator<TradeSkuOrderBean> stream) {
        ...
        c1Stream.print();
        //2> TradeSkuOrderBean(orderDetailId=23725, stt=2026-04-11 21:11:50, edt=2026-04-11 21:11:55, curDate=20260411, trademarkId=9, trademarkName=CAREMiLLE, category1Id=8, category1Name=个护化妆, category2Id=54, category2Name=香水彩妆, category3Id=477, category3Name=唇部, skuId=31, skuName=CAREMiLLE珂曼奶油小方口红 雾面滋润保湿持久丝缎唇膏 M03赤茶, spuId=10, spuName=CAREMiLLE珂曼奶油小方口红 雾面滋润保湿持久丝缎唇膏, originalAmount=138.0000, activityReduceAmount=0.0, couponReduceAmount=10.45, orderAmount=127.55, ts=1775913110000)
        //2> TradeSkuOrderBean(orderDetailId=23780, stt=2026-04-11 21:11:55, edt=2026-04-11 21:12:00, curDate=20260411, trademarkId=5, trademarkName=小米, category1Id=2, category1Name=手机, category2Id=13, category2Name=手机通讯, category3Id=61, category3Name=手机, skuId=1, skuName=小米12S Ultra 骁龙8+旗舰处理器 徕卡光学镜头 2K超视感屏 120Hz高刷 67W快充 12GB+512GB 冷杉绿 5G手机, spuId=1, spuName=小米12sultra, originalAmount=13998.0000, activityReduceAmount=1000.0, couponReduceAmount=0.0, orderAmount=12998.0, ts=1775913117000)
        //2> TradeSkuOrderBean(orderDetailId=23779, stt=2026-04-11 21:11:55, edt=2026-04-11 21:12:00, curDate=20260411, trademarkId=8, trademarkName=索芙特, category1Id=8, category1Name=个护化妆, category2Id=54, category2Name=香水彩妆, category3Id=477, category3Name=唇部, skuId=27, skuName=索芙特i-Softto 口红不掉色唇膏保湿滋润 璀璨金钻哑光唇膏 Z02少女红 活力青春 璀璨金钻哑光唇膏 , spuId=9, spuName=索芙特i-Softto 口红不掉色唇膏保湿滋润 璀璨金钻哑光唇膏 , originalAmount=129.0000, activityReduceAmount=0.0, couponReduceAmount=0.0, orderAmount=129.0, ts=1775913117000)
        //2> TradeSkuOrderBean(orderDetailId=23762, stt=2026-04-11 21:11:55, edt=2026-04-11 21:12:00, curDate=20260411, trademarkId=9, trademarkName=CAREMiLLE, category1Id=8, category1Name=个护化妆, category2Id=54, category2Name=香水彩妆, category3Id=477, category3Name=唇部, skuId=29, skuName=CAREMiLLE珂曼奶油小方口红 雾面滋润保湿持久丝缎唇膏 M01醉蔷薇, spuId=10, spuName=CAREMiLLE珂曼奶油小方口红 雾面滋润保湿持久丝缎唇膏, originalAmount=138.0000, activityReduceAmount=0.0, couponReduceAmount=0.0, orderAmount=138.0, ts=1775913115000)
        //2> TradeSkuOrderBean(orderDetailId=23774, stt=2026-04-11 21:11:55, edt=2026-04-11 21:12:00, curDate=20260411, trademarkId=6, trademarkName=长粒香, category1Id=14, category1Name=食品饮料、保健食品, category2Id=82, category2Name=粮油调味, category3Id=803, category3Name=米面杂粮, skuId=23, skuName=十月稻田 辽河长粒香 东北大米 5kg, spuId=7, spuName=十月稻田 长粒香大米 东北大米 东北香米 5kg, originalAmount=40.0000, activityReduceAmount=0.0, couponReduceAmount=0.0, orderAmount=40.0, ts=1775913116000)
        //2> TradeSkuOrderBean(orderDetailId=23763, stt=2026-04-11 21:11:55, edt=2026-04-11 21:12:00, curDate=20260411, trademarkId=9, trademarkName=CAREMiLLE, category1Id=8, category1Name=个护化妆, category2Id=54, category2Name=香水彩妆, category3Id=477, category3Name=唇部, skuId=31, skuName=CAREMiLLE珂曼奶油小方口红 雾面滋润保湿持久丝缎唇膏 M03赤茶, spuId=10, spuName=CAREMiLLE珂曼奶油小方口红 雾面滋润保湿持久丝缎唇膏, originalAmount=69.0000, activityReduceAmount=0.0, couponReduceAmount=0.0, orderAmount=69.0, ts=1775913115000)
        //2> TradeSkuOrderBean(orderDetailId=23768, stt=2026-04-11 21:11:55, edt=2026-04-11 21:12:00, curDate=20260411, trademarkId=3, trademarkName=联想, category1Id=6, category1Name=电脑办公, category2Id=33, category2Name=电脑整机, category3Id=287, category3Name=游戏本, skuId=15, skuName=联想（Lenovo） 拯救者Y9000P 2022 16英寸游戏笔记本电脑 i7-12700H 512G RTX3060 钛晶灰, spuId=4, spuName=联想（Lenovo） 拯救者Y9000P 2022 16英寸游戏笔记本电脑, originalAmount=9799.0000, activityReduceAmount=250.0, couponReduceAmount=0.0, orderAmount=9549.0, ts=1775913115000)
        //2> TradeSkuOrderBean(orderDetailId=23782, stt=2026-04-11 21:11:55, edt=2026-04-11 21:12:00, curDate=20260411, trademarkId=3, trademarkName=联想, category1Id=3, category1Name=家用电器, category2Id=16, category2Name=大 家 电, category3Id=86, category3Name=平板电视, skuId=35, skuName=华为智慧屏V65i 65英寸 HEGE-560B 4K全面屏智能电视机 多方视频通话 AI升降摄像头 4GB+32GB 星际黑, spuId=12, spuName=华为智慧屏 4K全面屏智能电视机, originalAmount=5499.0000, activityReduceAmount=0.0, couponReduceAmount=0.0, orderAmount=5499.0, ts=1775913117000)
        //2> TradeSkuOrderBean(orderDetailId=23781, stt=2026-04-11 21:11:55, edt=2026-04-11 21:12:00, curDate=20260411, trademarkId=11, trademarkName=香奈儿, category1Id=8, category1Name=个护化妆, category2Id=54, category2Name=香水彩妆, category3Id=473, category3Name=香水, skuId=32, skuName=香奈儿（Chanel）女士香水5号香水 粉邂逅柔情淡香水EDT 5号淡香水35ml, spuId=11, spuName=香奈儿（Chanel）女士香水5号香水 粉邂逅柔情淡香水EDT , originalAmount=600.0000, activityReduceAmount=0.0, couponReduceAmount=0.0, orderAmount=600.0, ts=1775913117000)
        //2> TradeSkuOrderBean(orderDetailId=23770, stt=2026-04-11 21:11:55, edt=2026-04-11 21:12:00, curDate=20260411, trademarkId=2, trademarkName=苹果, category1Id=2, category1Name=手机, category2Id=13, category2Name=手机通讯, category3Id=61, category3Name=手机, skuId=10, skuName=Apple iPhone 12 (A2404) 64GB 蓝色 支持移动联通电信5G 双卡双待手机, spuId=3, spuName=Apple iPhone 12, originalAmount=16394.0000, activityReduceAmount=0.0, couponReduceAmount=0.0, orderAmount=16394.0, ts=1775913115000)
    }
