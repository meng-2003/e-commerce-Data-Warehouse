...
public class DwdTradeRefundPaySucDetail extends BaseSQLApp {
    public static void main(String[] args) {
        new DwdTradeRefundPaySucDetail().start(
                10018,
                4,
                Constant.TOPIC_DWD_TRADE_REFUND_PAYMENT_SUCCESS_DETAIL
        );
    }
    ...
    public void handle(StreamExecutionEnvironment env,
        ...
        // 1. 读取 topic_db
        readOdsDb(tEnv, Constant.TOPIC_DWD_TRADE_REFUND_PAYMENT_SUCCESS_DETAIL);
        // 2. 读取 字典表
        readBaseDic(tEnv);
        ...
        // 7.写出到 kafka
        tEnv.executeSql("create table dwd_trade_refund_payment_success_detail(" +
                "id string," +
                "user_id string," +
                "order_id string," +
                "sku_id string," +
                ...
                "ts bigint " +
                ")" + SQLUtil.getKafkaDDLSink(Constant.TOPIC_DWD_TRADE_REFUND_PAYMENT_SUCCESS_DETAIL));
        result.executeInsert(Constant.TOPIC_DWD_TRADE_REFUND_PAYMENT_SUCCESS_DETAIL);
