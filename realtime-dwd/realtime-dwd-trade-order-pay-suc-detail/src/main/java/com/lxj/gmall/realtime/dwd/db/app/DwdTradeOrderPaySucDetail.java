...
public class DwdTradeOrderPaySucDetail extends BaseSQLApp {
    public static void main(String[] args) {
        new DwdTradeOrderPaySucDetail().start(
                10016,
                4,
                Constant.TOPIC_DWD_TRADE_ORDER_PAYMENT_SUCCESS_DETAIL
        );
    }
    ...
    public void handle(StreamExecutionEnvironment env,
        ...
        tEnv.executeSql(
                "create table dwd_trade_order_detail(" +
                        ...
                        ")" + SQLUtil.getKafkaDDLSource(Constant.TOPIC_DWD_TRADE_ORDER_PAYMENT_SUCCESS_DETAIL, Constant.TOPIC_DWD_TRADE_ORDER_DETAIL));

        // 2. 读取 topic_db
        readOdsDb(tEnv, Constant.TOPIC_DWD_TRADE_ORDER_PAYMENT_SUCCESS_DETAIL);
        ...
        // 6. 写出到 kafka 中
        tEnv.executeSql("create table dwd_trade_order_payment_success_detail(" +
                ...
                "ts bigint " +
                ")" + SQLUtil.getKafkaDDLSink(Constant.TOPIC_DWD_TRADE_ORDER_PAYMENT_SUCCESS_DETAIL));

        result.executeInsert(Constant.TOPIC_DWD_TRADE_ORDER_PAYMENT_SUCCESS_DETAIL);
    }
}
